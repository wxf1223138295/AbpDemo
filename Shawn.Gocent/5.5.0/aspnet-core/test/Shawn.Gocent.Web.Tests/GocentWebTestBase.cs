...
using Shawn.Gocent.Models.TokenAuth;
...
{
    public abstract class GocentWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static GocentWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(GocentWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<GocentDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<GocentDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<GocentDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<GocentDbContext, Task<T>> func)
        {
            T result;
